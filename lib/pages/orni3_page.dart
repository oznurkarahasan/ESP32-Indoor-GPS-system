...
const String orni3HaritaUrl =
    "https://drive.google.com/uc?export=view&id=1-rGQy7qUzATSE4Jzyh5KrXUGEFEZ7YZi";

class Orni3Page extends StatefulWidget {
  const Orni3Page({super.key});

  @override
  State<Orni3Page> createState() => _Orni3PageState();
}

class _Orni3PageState extends State<Orni3Page> with TickerProviderStateMixin {
  ...
  void _startNavigation(String destinationPOI) {
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              NavigationPage(startPOI: 'Orni3 Giriş', endPOI: targetPOI),
        ),
      );
    } catch (e) {
  ...
  void _openLocationSearch() {
    ...
    final orni3POIs =
        allBuildingPOIs.where((poi) => poi.floor == 'Orni3').toList();
    final otherPOIs =
        allBuildingPOIs.where((poi) => poi.floor != 'Orni3').toList();
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (orni3POIs.isNotEmpty) ...[
                        ...
                        ...orni3POIs.map((poi) => _buildPOITile(poi, true)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: "Orni3"),
      body: SafeArea(
        child: Column(
          children: [
            _buildSearchSection(),

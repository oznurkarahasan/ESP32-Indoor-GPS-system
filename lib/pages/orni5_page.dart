...
const String orni5HaritaUrl =
    "https://drive.google.com/uc?export=view&id=1-rGQy7qUzATSE4Jzyh5KrXUGEFEZ7YZi";

class Orni5Page extends StatefulWidget {
  const Orni5Page({super.key});

  @override
  State<Orni5Page> createState() => _Orni5PageState();
}

class _Orni5PageState extends State<Orni5Page> with TickerProviderStateMixin {
  ...
  void _startNavigation(String destinationPOI) {
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              NavigationPage(startPOI: 'Orni5 Giriş', endPOI: targetPOI),
        ),
      );
    } catch (e) {
  ...
  void _openLocationSearch() {
    ...
    final orni5POIs =
        allBuildingPOIs.where((poi) => poi.floor == 'Orni5').toList();
    final otherPOIs =
        allBuildingPOIs.where((poi) => poi.floor != 'Orni5').toList();
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (orni5POIs.isNotEmpty) ...[
                        ...
                        ...orni5POIs.map((poi) => _buildPOITile(poi, true)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: "Orni5"),
      body: SafeArea(
        child: Column(
          children: [
            _buildSearchSection(),

...
const String orni2HaritaUrl =
    "https://drive.google.com/uc?export=view&id=1-rGQy7qUzATSE4Jzyh5KrXUGEFEZ7YZi";

class Orni2Page extends StatefulWidget {
  const Orni2Page({super.key});

  @override
  State<Orni2Page> createState() => _Orni2PageState();
}

class _Orni2PageState extends State<Orni2Page> with TickerProviderStateMixin {
  ...
  void _startNavigation(String destinationPOI) {
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              NavigationPage(startPOI: 'Orni2 Giriş', endPOI: targetPOI),
        ),
      );
    } catch (e) {
  ...
  void _openLocationSearch() {
    ...
    final orni2POIs =
        allBuildingPOIs.where((poi) => poi.floor == 'Orni2').toList();
    final otherPOIs =
        allBuildingPOIs.where((poi) => poi.floor != 'Orni2').toList();
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (orni2POIs.isNotEmpty) ...[
                        ...
                        ...orni2POIs.map((poi) => _buildPOITile(poi, true)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: "Orni2"),
      body: SafeArea(
        child: Column(
          children: [
            _buildSearchSection(),

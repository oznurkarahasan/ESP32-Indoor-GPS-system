...
const String orni1HaritaUrl =
    "https://drive.google.com/uc?export=view&id=1-rGQy7qUzATSE4Jzyh5KrXUGEFEZ7YZi";

class Orni1Page extends StatefulWidget {
  const Orni1Page({super.key});

  @override
  State<Orni1Page> createState() => _Orni1PageState();
}

class _Orni1PageState extends State<Orni1Page> with TickerProviderStateMixin {
  ...
  void _startNavigation(String destinationPOI) {
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              NavigationPage(startPOI: 'Orni1 Giriş', endPOI: targetPOI),
        ),
      );
    } catch (e) {
  ...
  void _openLocationSearch() {
    ...
    final orni1POIs =
        allBuildingPOIs.where((poi) => poi.floor == 'Orni1').toList();
    final otherPOIs =
        allBuildingPOIs.where((poi) => poi.floor != 'Orni1').toList();
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (orni1POIs.isNotEmpty) ...[
                        ...
                        ...orni1POIs.map((poi) => _buildPOITile(poi, true)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: "Orni1"),
      body: SafeArea(
        child: Column(
          children: [
            _buildSearchSection(),
